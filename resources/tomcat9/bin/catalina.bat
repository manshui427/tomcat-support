...
rem set JAVA_HOME=C:\Java\jdk1.8.0_202\
rem set JAVA_OPTS="-Djava.awt.headless=true -Djava.security.egd=file:/dev/./urandom -Xms1024m -Xmx2048m -XX:MaxPermSize=1024m"
rem  -XX:PermSize=256m
